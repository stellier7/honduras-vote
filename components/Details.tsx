    ...
    <>
      ...
      >
        <Image
          ...
          width={3000}
          height={500}
          src={poll.image.startsWith('http') || poll.image.startsWith('/') ? poll.image : '/assets/images/question.jpeg'}
          alt={poll.title}
        />
      </div>
      ...
      >
        ...
        <div className=" h-[136px] gap-[16px] flex flex-col items-center mt-4">
          ...
          <div className="h-[36px] gap-[4px] flex justify-center items-center">
            ...
            >
              {poll.votes} {poll.votes === 1 ? 'voto' : 'votos'}
            </button>
            ...
            >
              {poll.contestants} {poll.contestants === 1 ? 'candidato' : 'candidatos'}
            </button>
